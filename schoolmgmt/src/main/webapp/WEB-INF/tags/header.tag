...
<header>
		...
		<ul class="rgba-blue-grey-strong custom-scrollbar ">
			...
			<li>
				<div class="logo-wrapper sn-ad-avatar-wrapper">
					<a href="#"><img src="" class="rounded-circle"><span
						style="color: white">Welcome, User</span></a>
				</div>
			</li>
			<!--/. Logo -->
			...
			<li>
				<ul class="collapsible collapsible-accordion">
					...
					<li class="nav-item "><a class="nav-link collapsed" href="#"
						data-toggle="collapse" data-target="#student">STUDENT</a>
						<div class="collapse" id="student" aria-expanded="false">
							<ul class="flex-column pl-2 nav">
								<li class="nav-item"><a class="nav-link py-0" href="<c:url value="/student/new"/>">New
										Student</a></li>
								<li class="nav-item"><a class="nav-link py-0" href="<c:url value="/student"/>">List
										Students</a></li>
							</ul>
						</div></li>
					<!--./STUDENT-->
					<!--EMPLOYEE-->
					<li class="nav-item "><a class="nav-link collapsed" href="#"
						data-toggle="collapse" data-target="#employee">EMPLOYEE</a>
					...
					<li class="nav-item "><a class="nav-link collapsed" href="#"
						data-toggle="collapse" data-target="#settings">SETTINGS</a>
						<div class="collapse" id="settings" aria-expanded="false">
							<ul class="flex-column pl-2 nav">
								<!--ACADEMIC DATES-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#academicdates">ACADEMIC
										DATES</a>
								...
								<!--BRANCH-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#branch">
										BRANCH </a>
								...
								<!--COMPANY -->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#company">
										COMPANY</a>
								...
								<!--DIFFERENTLY ABLE -->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#differentlyable">
										DIFFERENTLY ABLE</a>
									<div class="collapse" id="differentlyable"
										aria-expanded="false">
										<ul class="flex-column pl-2 nav">
								...
								<!--ETHNIC GROUP -->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#ethnicgroup">
										ETHNIC GROUP</a>
								...
								<!--EXAM -->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#exam"> EXAM</a>
								...
								<!--EXAM TYPE-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#examtype">
										EXAM TYPE</a>
								...
								<!--FACULTY-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#faculty">
										FACULTY </a>
								...
								<!--GENERAL DETAILS-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#generaldetails">
										GENERAL DETAILS </a>
								...
								<!--GRADE-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#grade"> GRADE
								</a>
								...
								<!--HOUSE GROUP-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#housegroup">
										HOUSE GROUP </a>
								...
								<!--MOTHER LANGUAGE-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#motherlanguage">
										MOTHER LANGUAGE </a>
								...
								<!--SECTION-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#section">
										SECTION </a>
								...
								<!--SUBJECTS-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#subjects">
										SUBJECTS </a>
								...
								<!--USER-->
								<li class="nav-item "><a class="nav-link collapsed"
									href="#" data-toggle="collapse" data-target="#user"> USER </a>
	...
	<nav class="navbar fixed-top navbar-expand-md primary-color lighten-2 double-nav scrolling-navbar top-nav-collapse">
		...
		<ul class="nav navbar-nav nav-flex-icons ml-auto">
			<a type="button" class="btn btn-info btn-rounded btn-sm">Log Out
